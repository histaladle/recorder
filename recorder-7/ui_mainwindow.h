...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        recTmLbl = new QLabel(centralWidget);
        recTmLbl->setObjectName(QStringLiteral("recTmLbl"));

        horizontalLayout->addWidget(recTmLbl);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        recTmLbl->setText(QApplication::translate("MainWindow", "00:00:00", 0));
